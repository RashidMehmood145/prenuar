              ...
              <div className="row justify-content-between">
                <div className="col-lg-3 mb-3 mb-lg-0">
                  <div className="footer-nav-wrap text-white">
                    ...
                    />
                    <p>
                    Find Pregnur Apps software downloads at play.google.com, 
                    the most comprehensive source for safe, trusted, 
                    and spyware-free downloads on the Web.
                    </p>
                  ...
                  <div className="footer-nav-wrap text-white">
                    ...
                    <ul className="list-unstyled support-list">
                      ...
                      <li className="mb-2 d-flex align-items-center">
                        ...
                        <a href="mailto:mail@example.com"> pregnurfeedback@gmail.com</a>
                      </li>
                      <li className="mb-2 d-flex align-items-center">
                        <span className="ti-world mr-2"></span>
                        <a href="/#"> www.pregnurfeedback.com</a>
                      </li>
                    </ul>
                  </div>
                </div>
